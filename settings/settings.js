...
async function loadData() {
  ...
  if (failed) {
    document.querySelector(".dashboard-content").innerHTML = `<div class="error-box" style="color:var(--ink)">Couldn't load your settings (${escapeHtml(failed.error.message)}).</div>`;
    return;
  }
